...
import { CourseGrid, courses } from "./components/CourseGrid";
...
const HomePage: React.FC = () => {
  ...
  return (
    <main className="flex-grow">
      ...
      <StudioGallery />
      <CourseGrid
        onCourseClick={(course) => navigate(`/formations/${course.id}`)}
      />
      <FeaturesSection />
      <TestimonialsSection />
      <FAQSection />
    ...
    <main className="flex-grow pt-32">
      <div className="max-w-7xl mx-auto px-6 mb-12">
        ...
        <p className="text-xl text-slate-500">
          Découvrez tous nos programmes de bien-être et développement personnel.
        </p>
      </div>
      <CourseGrid
        onCourseClick={(course) => navigate(`/formations/${course.id}`)}
...
const AboutPage: React.FC = () => (
  <main className="flex-grow pt-32">
    <div className="max-w-7xl mx-auto px-6 mb-12">
      ...
      <p className="text-xl text-slate-500">
        Découvrez notre vision et notre équipe passionnée.
      </p>
    </div>
    <AboutSection />
    <InstructorsSection />
...
const PublicPage: React.FC = () => (
  <main className="flex-grow pt-32">
    <div className="max-w-7xl mx-auto px-6 mb-12">
      ...
      <p className="text-xl text-slate-500">
        À qui s'adressent nos formations et pourquoi nous rejoindre.
      </p>
    </div>
    <FeaturesSection />
    <TestimonialsSection />
