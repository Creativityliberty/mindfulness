          ...
          <div className="max-w-5xl mx-auto px-6 md:px-12">
            <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-[3rem] p-12 text-white text-center shadow-3xl overflow-hidden relative">
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4 relative z-10">
                <button className="bg-white text-indigo-700 px-10 py-5 rounded-2xl text-xl font-bold hover:bg-indigo-50 hover:shadow-2xl transition-all flex items-center gap-3">
                  Voir nos formations
                  <ArrowRight size={24} />
                </button>
